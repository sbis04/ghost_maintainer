...
- P3-Low: Cosmetic issues, nice-to-haves, documentation gaps''';
    ...
    final responseText = await _callClaude(prompt);
    ...
    return TriageResult(
      ...
      reasoning: json['reasoning'] as String? ?? 'Unable to generate reasoning.',
    );
  }
...
Confidence is 0-100 representing how confident you are the fix is correct.''';
  ...
  Map<String, dynamic> _parseJson(String text) {
    ...
    throw FormatException('Could not parse Claude response as JSON: $text');
  }
...
class AnthropicApiException implements Exception {
  ...
  AnthropicApiException({required this.statusCode, required this.body});
